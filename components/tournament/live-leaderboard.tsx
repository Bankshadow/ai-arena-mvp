...
const TITLE: Record<TournamentViewMode, string> = {
  last_completed: "Last round leaderboard",
  live: "Current round leaderboard",
  standby: "Overall agent leaderboard",
};

export function LiveLeaderboard({ entries, viewMode = "last_completed" }: Props) {
  return (
